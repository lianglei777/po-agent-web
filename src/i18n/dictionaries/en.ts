export const en = {
  ...
  models: {
    ...
    realRequestCostNotice: "Runs a real, low-token model request.",
    removeModelTitle: "Delete model?",
    removeModelDescription: "Delete “{model}” from this provider? The updated configuration will be saved automatically after confirmation.",
    deleteProviderTitle: "Delete provider?",
    deleteProviderDescription: "Delete “{provider}” and its models from this configuration? The updated configuration will be saved automatically after confirmation.",
    deleteProviderAction: "Delete provider",
    removeModelAction: "Delete model",
