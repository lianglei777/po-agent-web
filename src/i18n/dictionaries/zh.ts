...
export const zh = {
  ...
  models: {
    ...
    realRequestCostNotice: "将发送一次低 token 的真实模型请求",
    removeModelTitle: "删除模型？",
    removeModelDescription: "确定从当前提供商中删除“{model}”吗？确认后更新的配置将自动保存。",
    deleteProviderTitle: "删除提供商？",
    deleteProviderDescription: "从当前配置中删除“{provider}”及其模型吗？确认后更新的配置将自动保存。",
    deleteProviderAction: "删除提供商",
    removeModelAction: "删除模型",
